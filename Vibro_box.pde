...
class VibroBox {
  ...
  VibroBox(PApplet app) {
    ...
    arduino = new Arduino(app, device, 57600);
  ...
  void turnOnFor(int millis, int d_Val) {
    final int u_Val = d_Val;
...
/** (Slightly) Modified version of the Arduino.java file - part of the Arduino library.
...
public class Arduino {
  ...
  public void digitalWrite(int pin, int value) {
    ...
    if (arduinoConnected) {
      ...
      if (verbose) { 
        println("Pin: "+pin+" digital value: "+value);
      }
    }
  }
  ...
  public void analogWrite(int pin, int value) {
    ...
    if (arduinoConnected) {
      ...
      if (verbose) { 
        println("Pin: "+pin+" analogue value: "+value);
      }
    }
  }
